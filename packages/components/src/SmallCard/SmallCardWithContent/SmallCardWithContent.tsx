...
export interface SmallCardWithContentProps {
    header?: string;
...
export const SmallCardWithContent = (props:SmallCardWithContentProps) => {
    const {header, children, logo = "default", className, style, elevation = 1, customLogo, logoSize = "medium", separator, footer} = props;
    const classes = useStyles();

    return (
      <SmallCard className={className} style={style} elevation={elevation} customLogo={customLogo} logoSize={logoSize} logo={logo}>
        {!!header &&
