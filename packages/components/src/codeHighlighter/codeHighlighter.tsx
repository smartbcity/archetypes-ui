...
import { atomOneDark, androidstudio, atomOneLight, darcula, gruvboxLight, hopscotch, tomorrowNight, tomorrow } from 'react-syntax-highlighter/dist/esm/styles/hljs'
import stringifyObject from 'stringify-object'
import { useMemo } from 'react'
import dedent from 'dedent';

export type darkStyles = "atomOneDark" | "androidstudio" | "darcula" | "hopscotch" | "tomorrowNight"
...
export const CodeHighlighter = (props: CodeHighlighterProps) => {
  const { code, children, indentCode = false, object, style = "atomOneDark", ...other } = props
